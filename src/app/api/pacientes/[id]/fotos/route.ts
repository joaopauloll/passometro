...
export async function POST(
    ...
    try {
        ...
        const lateralidade =
            (formData.get("lateralidade") as string) || null;
        ...
        // URL protegida pelo endpoint /api/uploads
        const url = `/api/uploads/pacientes/${pacienteId}/${filename}`;
        ...
        const foto = await prisma.foto.create({
            data: {
                ...
                lateralidade,
                url,
                dataFoto: dataFotoStr
                    ? new Date(dataFotoStr)
                    : null,
                descricao,
            },
        });
